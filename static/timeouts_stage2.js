document.addEventListener("DOMContentLoaded", function () {
    ...
    window.callTimeout = function () {
      ...
      imgContainer.innerHTML = `<img src="/static/images/players_with_space.png" alt="Players" class="img-fluid mt-3" style="max-width: 300px;">`;
      document.querySelector(".timeouts-section").appendChild(imgContainer);
  
      /* Inject bottom-right Next button */
      nextPlaceholder.innerHTML = `<a href="#" id="next-seq" class="bottom-buttons">Next</a>`;
